...
f = h5py.File('./network/cortex_cortex_edges.h5','r')
g = h5py.File('./network/cortex_nodes.h5','r')

source = f['edges']['cortex_to_cortex']['source_node_id']
target = f['edges']['cortex_to_cortex']['target_node_id']

n_cells = 1000
pn_ids = np.arange(0,799)
itn_ids = np.arange(800,893)

positions = g['nodes']['cortex']['0']['positions']
y_angles = g['nodes']['cortex']['0']['rotation_angle_yaxis']
z_angles = g['nodes']['cortex']['0']['rotation_angle_zaxis']
