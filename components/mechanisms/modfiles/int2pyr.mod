...
PARAMETER {
	...
	facfactor = 1
	: the (1) is needed for the range limits to be effective : FSI -> PN is depressing with d1=0.7 d2=1 taud1=300 taud2= 1
        f = 0 (1) < 0, 10 > : 1.3 (1) < 0, 1e9 >    : facilitation
        tauF = 20 (ms) < 1e-9, 1e9 >
        d1 = 0.7 (1) < 0, 1e9 >     : fast depression  should be 300
        tauD1 = 300 (ms) < 1e-9, 1e9 >  
        d2 = 1 (1) < 0, 1 >     : slow depression  should be 1
        tauD2 = 1 (ms) < 1e-9, 1e9 >	
